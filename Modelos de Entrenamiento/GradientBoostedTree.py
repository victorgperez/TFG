...
for column in ["srcip", "sport","dstip","dsport","proto", "state","dur","sbytes","dbytes","sttl","dttl","sloss","dloss","service","Sload","Dload","Spkts","Dpkts","swin","dwin","stcpb","dtcpb","smeansz","dmeansz","trans_depth","res_bdy_len","Sjit","Djit", "Stime","Ltime","Sintpkt","Dintpkt","tcprtt","synack","ackdat","is_sm_ips_ports","ct_state_ttl","ct_flw_http_mthd","is_ftp_login","ct_ftp_cm","ct_srv_src","ct_srv_dst","ct_dst_ltm","ct_src_ ltm", "ct_src_dport_ltm","ct_dst_sport_ltm", "ct_dst_src_ltm", "label", "attack_cat"]:
  ...
  base_path = "."
  string_indexer_output_path = "{}/data/string_indexer_gbt/string_indexer_model_{}.bin".format(
  base_path,
  column
      )
...
vector_assembler_path = "{}/data/numeric_vector_assembler_gbt.bin".format(base_path)
...
gbt = GBTClassifier(labelCol="attack_cat_index", featuresCol="Features_vec", maxIter=100,
  maxBins=277906)

model = gbt.fit(train)
model_output_path = "{}/data/GradienBoostedTree.bin".format( base_path)
...
evaluator = MulticlassClassificationEvaluator(
    labelCol="attack_cat_index", predictionCol="prediction", metricName="accuracy")
