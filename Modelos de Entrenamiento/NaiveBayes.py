...
index_columns_to_assembler = ["srcip_index", "sport_index","dstip_index","dsport_index","proto_index", "state_index","dur_index","sbytes_index","dbytes_index","sttl_index","dttl_index","sloss_index","dloss_index",
...
index_columns = ["srcip", "sport","dstip","dsport","proto", "state","dur","sbytes","dbytes","sttl","dttl","sloss","dloss","service","Sload","Dload","Spkts","Dpkts","swin","dwin","stcpb","dtcpb","smeansz","dmeansz","trans_depth","res_bdy_len","Sjit","Djit", "Stime","Ltime","Sintpkt","Dintpkt","tcprtt","synack","ackdat","is_sm_ips_ports","ct_state_ttl","ct_flw_http_mthd","is_ftp_login","ct_ftp_cm","ct_srv_src","ct_srv_dst","ct_dst_ltm","ct_src_ ltm", "ct_src_dport_ltm","ct_dst_sport_ltm", "ct_dst_src_ltm", "label", "attack_cat","srcip_index", "sport_index","dstip_index","dsport_index","proto_index", "state_index","dur_index","sbytes_index","dbytes_index","sttl_index","dttl_index","sloss_index","dloss_index",
                   "service_index","Sload_index","Dload_index","Spkts_index","Dpkts_index", "swin_index","dwin_index","stcpb_index","dtcpb_index","smeansz_index","dmeansz_index","trans_depth_index","res_bdy_len_index","Sjit_index","Djit_index", "Stime_index","Ltime_index","Sintpkt_index","Dintpkt_index","tcprtt_index","synack_index","ackdat_index","is_sm_ips_ports_index","ct_state_ttl_index","ct_flw_http_mthd_index","is_ftp_login_index","ct_ftp_cm_index","ct_srv_src_index","ct_srv_dst_index","ct_dst_ltm_index","ct_src_ ltm_index", "ct_src_dport_ltm_index","ct_dst_sport_ltm_index", "ct_dst_src_ltm_index", "label_index"]
